...
import { Button, buttonVariants } from "@seiseisai/ui/components/button";
    ...
    return (
        <Button
            ...
            className={cn(
                ...
                dark:hover:text-accent-foreground flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1
                leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10
                ...
                data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md [&>span]:text-xs
                [&>span]:opacity-70`,
                defaultClassNames.day,
                className,
            )}
