...
import { addNews, changeNewsSafe, changeNewsUnsafe, deleteNews, getAllNews } from "@/impl/database-actions";
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            onClick={async (e) => {
                                ...
                                if (create) {
                                    const result = await addNews(parsed.data);
                                    if (result === null) {
                                    ...
                                    const result = await changeNewsSafe(placeholder, parsed.data);
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            onClick={async () => {
                                ...
                                const result = await changeNewsUnsafe(parsed.data);
                                if (result) {
                                    toast.success("ニュースを保存しました。", {
                                        duration: 2000,
                                    });
